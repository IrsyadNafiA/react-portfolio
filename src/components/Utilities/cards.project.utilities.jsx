...
const CardsProject = () => {
    return(
        <div className="card flex flex-col gap-8">
            ...
            <>
            <div key={i} className="block bg-white border max-w-[920px] mx-4 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" data-aos="zoom-in-up">
