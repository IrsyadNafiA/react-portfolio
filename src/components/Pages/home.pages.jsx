                ...
                <div className="m-auto flex flex-col gap-4">
                    <div className="hero-main gap-2 lg:gap-12 md:gap-12 sm:gap-12 flex flex-col-reverse lg:flex-row m-4">
                        <div className="hero-text text-center lg:text-start">
                            ...
                            <p className="text-gray-500 my-8" data-aos="fade-right">Hi, I'm Irsyad Nafi Alif Perdana. A passionate student based in Batam, Indonesia. 📍</p>
                            <span className="flex gap-4 justify-center lg:justify-start" data-aos="fade-right">
                                <a href="https://www.linkedin.com/in/irsyad-nafi-87097b259/" target="blank" className="text-gray-900 hover:text-blue-700"><FaLinkedin size={32}/></a>
                                <a href="https://github.com/IrsyadNafiA" target="blank" className="text-gray-900 hover:text-blue-700"><FaGithub size={32}/></a>
                            </span>
                        </div>
                        <div className="hero-img flex justify-center mt-20 lg:mt-0 md:mt-0 sm:mt-0 mb-2">
                            <img className="rounded-full h-64 lg:h-96 sm:h-80 max-w-sm hover:drop-shadow-xl" src={Irsyad} alt="" data-aos="fade-left"/>
                        </div>
                    </div>
                    <div className="skills flex flex-col gap-4 items-center lg:flex-row lg:mt-8" data-aos="fade-up">
                        <h3 className="text-xl border-0 font-bold lg:border-r-2 border-gray-900 pr-4">My Skills</h3>
